...
class EmailServiceImplTest {
    ...
    @Test
    void send() {
        emailService.send("ushan@email.com",buildEmail("Ushanandhan","www.google.com"));
    ...
    void sendMailWithThymeleafTemplate() throws AddressException {
        ...
        emailService.send(toAddresses,ccAddresses,"Testing-Email-Using-Thymeleaf","test-email.html",templateModel);
    }
